...
# allowed FX symbols
SYMBOLS = ['AUDCADc', 'AUDCHFc', 'AUDJPYc', 'AUDNZDc', 'AUDUSDc', 'CADCHFc', 'CADJPYc', 'CHFJPYc', 'EURAUDc', 'EURCADc', 'EURCHFc', 'EURGBPc', 'EURJPYc', 'EURNZDc', 'EURUSDc', 'GBPAUDc', 'GBPCADc', 'GBPCHFc', 'GBPJPYc', 'GBPNZDc', 'GBPUSDc', 'NOWc', 'NZDCADc', 'NZDCHFc', 'NZDJPYc', 'NZDUSDc', 'USDCADc', 'USDCHFc', 'USDJPYc', 'XAGUSDc', 'XAUUSDc']
...
def unknown_command(update: Update, context: CallbackContext) -> None:
    ...
    if(not(update.effective_message.chat.username == TELEGRAM_USER)):
        update.effective_message.reply_text("You are not authorized !")
        return

    update.effective_message.reply_text("Try again .")
